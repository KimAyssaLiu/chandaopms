...
headers = {"Cache-Control": "max-age=0",
               "Origin": "http://192.168.1.100", "Upgrade-Insecure-Requests": "1",
               "Content-Type": "application/x-www-form-urlencoded",
               "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36",
               "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
               "Referer": "http://192.168.1.100/zentao/product-create.html", "Accept-Encoding": "gzip, deflate",
...
def addproduct():
    ...
    url = "http://192.168.1.100:80/zentao/product-create.html"
...
def addbug():
    ...
    url = "http://192.168.1.100:80/zentao/bug-create-1-0-moduleID=0.html"
